        ...
        {!isMobile && (
          ...
          >
            ...
            <div style={{ display: "flex", gap: "28px", alignItems: "center" }}>
              {['Search', '(0)'].map((item) => (
                <span key={item} style={{ color: "#fff", fontSize: "11px", letterSpacing: "0.18em", textDecoration: "none", textTransform: "uppercase", fontFamily: "'Georgia', serif", fontWeight: 400, opacity: 0.85 }}>
                  {item}
                </span>
              ))}
            </div>
